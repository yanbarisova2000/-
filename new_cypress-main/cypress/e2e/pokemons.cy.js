describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('yanbarisova2705@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('5a0a3e95b591ae8e429f7590b4f34968');               // вводим пароль
         ...
         cy.get('.card_name').type('yanbarisova');                           // вводим имя владельца действия карты
